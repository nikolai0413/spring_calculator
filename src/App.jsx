...
import { materials, endTypes, mainSchema, mainResultsTemplate, staticResultsTemplate } from './data.js';
  ...
  calculateMain() {
    this.setState(

      {
        ...
        mainResults: { ...mainResultsTemplate }, // clear results table and start loading spinner
        ...
        this.validateMain(() => {
          if (!this.state.inputError.main) {
            axios
              ...
              .catch((err) => {
                console.log(err);
                this.setState({ backendError: { main: true }, loading: { main: false }});
              });
          } else {
          ...
          <div className='row align-items-md-stretch' id='start'>
            ...
            <div className='row mt-1 justify-content-center'>
              ...
              <div className='row justify-content-center'>
                <div className='col-md-3 text-center mt-4'>
                  <a className='btn btn-primary btn-lg form-control'>
                    Calculate
                  </a>
                </div>
              </div>
                ...
                <div className='col-md-6'>
                  <table className='table table-bordered table-hover'>
                    ...
                    <tbody>
                      <tr>
                        <td scope='row'>
                          Factor of Safety <i>n<sub>s</sub></i>
                        </td>
